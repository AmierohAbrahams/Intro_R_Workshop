...
2. Make use of x:y notation to make a second vector called vec_2 containing the numbers 1 to 5.

3. Subtract vec_2 from vec_1 and look at the result.
